...
func main()  {
	...
	for _, object := range dataArr{
		for _, object_ := range object.Data{
			object_.firstIter = LogarithmAppr(object_.Data)

			//fmt.Println(strconv.FormatFloat(object_.firstIter.b, 'f', 10, 64))
			//fmt.Println(strconv.FormatFloat(object_.firstIter.a, 'f', 10, 64))
			object.lArr = append(object.lArr, [2]float64{object_.L, -object_.firstIter.a})
		...
		fmt.Println(strconv.FormatFloat(object.secondIter.pow, 'f', 10, 64))
		fmt.Println(strconv.FormatFloat(object.secondIter.base, 'f', 10, 64))
	}
